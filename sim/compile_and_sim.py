...
def compile():
    ...
    # testbench 文件
    iverilog_cmd.append(rtl_dir + r'/tb/rvlife_seq_tb.v')

    # 内核core
    iverilog_cmd.append(rtl_dir + r'/rtl/define.v')
    iverilog_cmd.append(rtl_dir + r'/rtl/pc_reg.v')
    iverilog_cmd.append(rtl_dir + r'/rtl/fetch.v')
    iverilog_cmd.append(rtl_dir + r'/rtl/rom.v')
    iverilog_cmd.append(rtl_dir + r'/rtl/decode.v')
    iverilog_cmd.append(rtl_dir + r'/rtl/regs_file.v')
    iverilog_cmd.append(rtl_dir + r'/rtl/execute.v')
    iverilog_cmd.append(rtl_dir + r'/rtl/ram.v')    
    iverilog_cmd.append(rtl_dir + r'/rtl/rvlife_seq.v')
